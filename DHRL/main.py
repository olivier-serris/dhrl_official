...
def get_args():
    ...
    # parser.add_argument("--env_name", type=str, default="DubinsUMaze-v0")
    # parser.add_argument("--test_env_name", type=str, default="DubinsUMaze-v0")
    parser.add_argument("--env_name", type=str, default="PointMaze_UMaze-eval-v3")
    parser.add_argument("--test_env_name", type=str, default="PointMaze_UMaze-eval-v3")
    # parser.add_argument("--env_name", type=str, default="AntMaze_UMaze-eval-v5")
    # parser.add_argument("--test_env_name", type=str, default="AntMaze_UMaze-eval-v5")

    parser.add_argument(
        "--action_max", type=float, default=30.0
    )  # network action_max > always 1
    parser.add_argument("--max_steps", type=int, default=600)
    parser.add_argument("--high_future_step", type=int, default=15)
    parser.add_argument("--subgoal_freq", type=int, default=40)
    parser.add_argument("--subgoal_scale", type=float, nargs="+", default=[12.0, 12.0])
    parser.add_argument("--subgoal_offset", type=float, nargs="+", default=[8.0, 8.0])
